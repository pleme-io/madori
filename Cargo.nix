    ...
    crates = {
      ...
      "garasu" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "2cd8bb78297f93de10607b0924ae781f536bd287";
          sha256 = "06xdc10747j7drfp9rdfldl0yq0rf0njzf7kv9x0fyd82lfj9rxg";
        };
        dependencies = [
          {
            name = "glyphon";
      ...
      "shikumi" = rec {
        ...
        src = pkgs.fetchgit {
          ...
          rev = "826aa8c6f868d93992a065f6791b5f035c184d4d";
          sha256 = "0pjcyphn6f608vn2pqhkyjb2ml7zkbqvgbf7hns8yxs4ym85zc86";
        };
        dependencies = [
          {
            name = "arc-swap";
